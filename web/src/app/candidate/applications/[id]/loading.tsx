            ...
            <div className="relative z-10 flex flex-col items-center gap-6">
                <div className="relative">
                    <div className="h-20 w-20 rounded-2xl bg-white border border-teal-100 shadow-xl flex items-center justify-center">
                        <Briefcase className="h-10 w-10 text-teal-600 animate-pulse" />
                    </div>
                ...
                <div className="text-center space-y-2">
                    <h3 className="text-xl font-bold text-slate-900">Loading Application...</h3>
                    <p className="text-slate-500 animate-pulse">Fetching interview details</p>
                </div>
            </div>
        </div>
    )
